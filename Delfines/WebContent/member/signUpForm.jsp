				...
				/* $.ajax({
					...
					error:function(error){
						...
						$(document).ready(function(){
							$("#confirm").css("display",""); // 인증번호 입력 칸 보이게 함
							$("#checkNumber").css("display","none"); // 인증번호 받기 버튼을 숨김
							$("#sign").css("display",""); // 회원가입 버튼을 보이게 함.
						});
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<div class="carousel-caption1zz"
				style="height: 44.3em; text-align: center; color: #FFFFFF; background-image: url('../images/bg01.jpg');">
				<br /> 
